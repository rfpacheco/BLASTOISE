...
from extra.functions import get_sequence, simple_fasta_creator, blastn_blaster, csv_to_fasta_creator, recaught_blast
...
def main():
    ...
    folder_path = os.path.join(output_path, 'tmp_trueSiderFilter')
    ...
    genome_folder_path = os.path.join(output_path, 'blastn_dic')
    ...
    if not no_data.empty:
        ...
        caught_data = recaught_blast(recaught_file_path, no_data_fasta_path, 60, args.word_size)
        # TODO: improve reusability
